...
This site covers `magdicom/hooks` `v2.0.0-beta.2` and `magdicom/laravel-hooks` `v2.0.0-beta.3`. The [source audit](https://github.com/magdicom/hooks-docs/blob/main/source-audit.md) links the package metadata, implementation, and tests behind these pages.
...
<Tabs syncKey="framework">
  <TabItem label="PHP">
    ...
    $hooks->addAction('InvoicePaid', $listener);
